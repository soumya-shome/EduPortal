...
const Footer = () => {
  ...
  const handleSwitchToLogin = () => {
    setShowRegisterModal(false);
    // Note: We don't have access to login modal from footer, so we'll just close
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">EduPortal</span>
            </div>
            <p className="text-gray-300 text-sm">
              Empowering education through technology. Connect with the best teachers and institutions 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/institutions" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm">
                  Find Teachers
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-300 text-sm">
                <AcademicCapIcon className="h-4 w-4 mr-2 text-blue-400" />
                Expert Instructors
              </li>
              <li className="flex items-center text-gray-300 text-sm">
